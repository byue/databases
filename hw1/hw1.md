...
```sh
$ git remote -v
  origin	git@gitlab.cs.washington.edu:CSE344-2018wi/cse344-[your CSE username].git (fetch)
  origin	git@gitlab.cs.washington.edu:CSE344-2018wi/cse344-[your CSE username].git (push)
