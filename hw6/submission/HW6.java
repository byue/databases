...
public class HW6 {
  ...
  public static Dataset<Row> Q1 (SparkSession spark, String dataFile) {
    ...
    // your code here
    return df.filter(df.col("origincityname").eqNullSafe("Seattle, WA"))
    		     .select(df.col("destcityname"))
    		     .distinct();
  }
  ...
  public static JavaRDD<Row> Q2 (SparkSession spark, String dataFile) {
    ...
    // your code here
    return d.filter(t -> (t.getString(ORIGIN_CITY_NAME).equals("Seattle, WA")))
    	      .map(t -> RowFactory.create(t.getString(DEST_CITY_NAME)))
    	      .distinct();
  }
  ...
  public static JavaPairRDD<Tuple2<String, Integer>, Integer> Q3 (SparkSession spark, String dataFile) {
    ...
    // your code here
    return d.filter(t -> (t.getInt(CANCELLED) != 1))
  ...
  public static Tuple2<String, Integer> Q4 (SparkSession spark, String dataFile) {
    ...
    // your code here
    return d.map(t -> new Tuple2<String, String>(t.getString(ORIGIN_CITY_NAME), t.getString(DEST_CITY_NAME)))
    	      .distinct()
  ...
  public static JavaPairRDD<String, Double> Q5 (SparkSession spark, String dataFile) {
    ...
    return d.filter(t -> (!t.isNullAt(DEP_DELAY)))
        .mapToPair(t -> new Tuple2<String, Tuple2<Integer, Integer>>(t.getString(ORIGIN_CITY_NAME),
			                  new Tuple2<Integer, Integer>(t.getInt(DEP_DELAY), 1)))
        .reduceByKey((x, y) -> new Tuple2<Integer, Integer>(x._1() + y._1(), x._2() + y._2()))
        .mapValues(val -> (((double) val._1()) / val._2()));
  }
